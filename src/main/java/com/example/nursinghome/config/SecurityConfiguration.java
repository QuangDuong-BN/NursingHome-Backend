...
public class SecurityConfiguration {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, TokenVersionFilter tokenVersionFilter) throws Exception {
        http
                .csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/swagger-ui", "/swagger-ui/**", "/error",
                ...
                .addFilterBefore(tokenVersionFilter, UsernamePasswordAuthenticationFilter.class);
        return http.build();
    }
